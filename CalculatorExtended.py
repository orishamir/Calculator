...
from SearchFuncs import searchChar, searchSigma, searchSplittingComma
...
expr = input(
    ":"
)  # "-S(n=0,80,(((-1)^n)/((2*n)!))*30^(2*n))" #"S(a=l(2,8),l(2,16),a*2)"  # "√(S(a=1,25,1))"  # "S(a=l(2,8),3,S(b=l(2,2^2),2,a*b+2))"  # "sin(√l(l(l(4,16),8),3^9)*10)"  # "6!/(5!*6+1)"
print("\n\n")
try:
    tree = calc(
        (expr)
